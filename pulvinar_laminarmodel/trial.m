...
totalinput=zeros(5,round(triallength/dt));
rate=zeros(5,round(triallength/dt));
transfer=zeros(5,1);
xi=normrnd(0,1,5,round(triallength/dt)); %noise for re2,ri2,re5,ri5, pulv and both areas
input=zeros(5,1);
